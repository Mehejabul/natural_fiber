                    ...
                    <div class="col-lg-12 col-md-7">
                        <div class="header_top_settings">
                            <ul>
                                ...
                                <li>Email:shahjalal4645@gmail.com</li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="column1 col-lg-3 col-md-3 col-4">
                        <div class="logo">
                            <a href="<?php echo e(route('client.home')); ?>"><img
                                    src="<?php echo e(asset('images/golden-jute/logo/logo.png')); ?>" alt="logo"></a>
                        </div>
                    </div>
...
</header><?php /**PATH G:\natural_fiber\resources\views/client/layouts/secondary.blade.php ENDPATH**/ ?>