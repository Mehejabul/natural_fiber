                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                               ...
                               <form method="POST" action="<?php echo e(route('documentory.store')); ?>" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
