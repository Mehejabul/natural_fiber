        ...
        <div class="content-header-left col-12 mb-2 mt-1">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    ...
                    <?php endif; ?>
                    <h5 class="content-header-title float-left pr-1 mb-0">Slider Table</h5>
                        ...
                        <div class="card-header">
                            ...
                            <div class="heading-elements">
                                <ul class="list-inline mb-0">
                                    <li class="ml-2"><a href="<?php echo e(route('banner.create')); ?>" class="btn btn-primary">+ Create</a></li>
                                </ul>
                            </div>
                        </div>
                                        ...
                                        <tbody>
                                            <?php if($banners): ?>
                                                <?php $__currentLoopData = $banners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        <td class="text-bold-600" ><img src="<?php echo e(asset('images/banner/'.$banner->image)); ?>" alt="" height="150px"></td>
                                                        
                                                        <td>
                                                            <?php if($banner->status == 'Active'): ?>
                                                                <a class="updateBannerStatus" id="banner-<?php echo e($banner->id); ?>"
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <a class="dropdown-item" href="<?php echo e(route('banner.edit',$banner->id)); ?>"><i class="bx bx-edit-alt mr-1"></i> edit</a>
                                                                    <form action="<?php echo e(route('banner.destroy',$banner->id)); ?>" method="post"> <?php echo csrf_field(); ?> <?php echo method_field('Delete'); ?>
        ...
        $(document).ready(function (){
            $(document).on("click", ".updateBannerStatus", function () {
                ...
                $.ajax({
                    ...
                    type: "post",
                    url: "<?php echo e(route('updateBannerStatus')); ?>",
...
<?php echo $__env->make('server.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Asus\Desktop\natural_fiber\resources\views/server/banner/index.blade.php ENDPATH**/ ?>