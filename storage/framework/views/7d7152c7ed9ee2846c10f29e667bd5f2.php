        ...
        <div class="content-header-left col-12 mb-2 mt-1">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    ...
                    <?php endif; ?>
                    <h5 class="content-header-title float-left pr-1 mb-0">Product Variation Stock Table</h5>
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb p-0 mb-0">
                            <li class="breadcrumb-item"><a href="<?php echo e(route('admin.dashboard')); ?>"><i
                                        class="bx bx-home-alt"></i></a>
                            </li>
                            <li class="breadcrumb-item active">Product Variation Stock Details
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title text-primary">Product Variation Stock List</h5>
                                        ...
                                        <tbody>
                                            <?php if($variants): ?>
                                                <?php $__currentLoopData = $variants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $variant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        <td class="text-primary"><?php echo e($variant->product->title); ?></td>
                                                        <td class="text-primary"><?php echo e($variant->productvariation->size); ?></td>
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                        ...
                                                                        <a class="dropdown-item" href="<?php echo e(route('stock.variantEdit',$variant->id)); ?>"><i class="bx bx-edit-alt mr-1"></i> edit</a>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
...
<?php echo $__env->make('server.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/zariijsr/abrarmart.com/resources/views/server/stock/details.blade.php ENDPATH**/ ?>