                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        <a href=<?php echo e(route('abouts.create')); ?> class="btn btn-primary mb-2  align-items-center"> Create
                                            </a>
                                            ...
                                            <table class="table add-rows">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th>
                                                           <?php echo e(Str::limit($about -> short_description,100)); ?>

                                                        
                                                        </th>
                                                        <th>
                                                           <?php echo e(Str::limit($about -> description,100)); ?>
                                                        ...
                                                        <th></th>
                                                         <td>
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                ...
                                                                <a href="<?php echo e(route('abouts.edit', $about->id)); ?>" class="dropdown-item">
                                                                        <i class="bx bx-edit-alt mr-1"></i> Edit
                                                                </a>
                                                             

                                                             
                                                                    <form action="<?php echo e(route('abouts.destroy',$about->id)); ?>" method="post"> <?php echo csrf_field(); ?> <?php echo method_field('Delete'); ?>
