...
<div class="content-header row">
    <div class="content-header-left col-12 mb-2 mt-1">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h5 class="content-header-title float-left pr-1 mb-0">Ad Edit</h5>
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb p-0 mb-0">
                        <li class="breadcrumb-item"><a href="<?php echo e(route('admin.dashboard')); ?>"><i class="bx bx-home-alt"></i></a>
                        </li>
                        <li class="breadcrumb-item"><a href="<?php echo e(route('ad.index')); ?>">Ads</a>
                        </li>
                        <li class="breadcrumb-item active">Ad Edit
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-content">
                        <form action="<?php echo e(route('ad.update',$ad->id)); ?>" method="post" enctype="multipart/form-data"> <?php echo csrf_field(); ?> <?php echo method_field('put'); ?>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-10">
                                        <fieldset>
                                            <h5>Ad <span class="star">*</span></h5>
                                        ...
                                        <?php if($ad->image != null): ?>
                                            <img src="<?php echo e(asset('images/ad/'.$ad->image)); ?>" id="output" alt="logo" width="600px" height="200px" class="mt-2 mx-1">
                                        <?php endif; ?>
                                        ...
                                        <fieldset class="mt-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select class="form-control" name="type" id="" required>
                                                    <option <?php if($ad->type == 'short'): ?>
                                                                selected
                                                            <?php endif; ?> value="short">Short Ad</option>
                                                    <option <?php if($ad->type == 'long'): ?>
                                                                selected
                                                            <?php endif; ?> value="long">Long Ad</option>
                                                </select>
                                            </div>
                                        </fieldset>
                                        <fieldset class="mt-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select class="form-control" name="view_section" id="" required>
                                                    <option <?php if($ad->view_section == 'bellow_slider'): ?>
                                                                selected
                                                            <?php endif; ?> value="bellow_slider">Bellow Slider</option>
                                                    <option <?php if($ad->view_section == 'bellow_trending_categories'): ?>
                                                                selected
                                                            <?php endif; ?> value="bellow_trending_categories">Bellow Trending Categories</option>
                                                    <option <?php if($ad->view_section == 'bellow_new_arrivals'): ?>
                                                                selected
                                                            <?php endif; ?> value="bellow_new_arrivals">Bellow New Arrivals</option>
                                                    <option <?php if($ad->view_section == 'bellow_featured_products'): ?>
                                                                selected
                                                            <?php endif; ?> value="bellow_featured_products">Bellow Featured Products</option>
                                                    <option <?php if($ad->view_section == 'bellow_product_type'): ?>
                                                                selected
                                                            <?php endif; ?> value="bellow_product_type">Bellow Product Type</option>
                                                </select>
                                            </div>
                                        </fieldset>
...
<?php echo $__env->make('server.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/zariijsr/abrarmart.com/resources/views/server/ad-zone/edit.blade.php ENDPATH**/ ?>