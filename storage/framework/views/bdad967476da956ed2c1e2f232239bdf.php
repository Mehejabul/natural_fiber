                ...
                <div class="col-lg-12 col-md-12">
                    <div class="copyright_area text-center">
                        <p>&copy; <?php echo e(date('Y')); ?> <a href="<?php echo e(route('client.home')); ?>" class="text-uppercase"><?php echo e($title); ?></a>.
                            <a target="_blank" href="https://zariq.com.bd/" class="copyright"><?php echo e($copyright); ?></a></p>
                    </div>
                    <div class="col-lg-12 col-md-12">
...
<?php /**PATH C:\xampp\htdocs\client_lifestyle\resources\views/client/layouts/footer.blade.php ENDPATH**/ ?>