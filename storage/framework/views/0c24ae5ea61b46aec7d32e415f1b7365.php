                                ...
                                <div class="card-header">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                           <div >
                                            <h3>Title</h3>
                                                <input value="<?php echo e($gallery -> title); ?>" type="title" name="title" class="form-control" id="inputGroupFile04" aria-describedby="inputGroupFileAddon04" required>
                                            <h3>Name</h3>
                                                <input value="<?php echo e($gallery -> name); ?>" type="name" name="name" class="form-control" id="inputGroupFile04" aria-describedby="inputGroupFileAddon04" required>
