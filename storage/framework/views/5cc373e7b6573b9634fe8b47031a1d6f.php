        ...
        <div class="content-header-left col-12 mb-2 mt-1">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    ...
                    <?php endif; ?>
                    <h5 class="content-header-title float-left pr-1 mb-0">Product Type Table</h5>
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb p-0 mb-0">
                            <li class="breadcrumb-item"><a href="<?php echo e(route('admin.dashboard')); ?>"><i class="bx bx-home-alt"></i></a>
                            </li>
                            <li class="breadcrumb-item active">Product types
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">Product Types List</h5>
                            <div class="heading-elements">
                                <ul class="list-inline mb-0">
                                    <li class="ml-2"><a href="<?php echo e(route('product-type.create')); ?>" class="btn btn-primary">+ Create</a></li>
                                </ul>
                            </div>
                        </div>
                                        ...
                                        <tbody>
                                            <?php if($banners): ?>
                                                <?php $__currentLoopData = $banners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        <td class="text-bold-600" ><img src="<?php echo e(asset('images/product_type/'.$banner->image)); ?>" alt="" height="150px"></td>
                                                        
                                                        <td><?php echo e($banner->title); ?></td>
                                                        <td>
                                                            <?php if($banner->status == 'Active'): ?>
                                                                <a class="updateProductTypeStatus" id="product_type-<?php echo e($banner->id); ?>"
                                                                    product_type = "<?php echo e($banner->id); ?>"
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <a class="dropdown-item" href="<?php echo e(route('product-type.edit',$banner->id)); ?>"><i class="bx bx-edit-alt mr-1"></i> edit</a>
                                                                    <form action="<?php echo e(route('product-type.destroy',$banner->id)); ?>" method="post"> <?php echo csrf_field(); ?> <?php echo method_field('Delete'); ?>
...
<?php $__env->startSection('js'); ?>
    ...
    <script>
        ...
        $(document).ready(function (){
            $(document).on("click", ".updateProductTypeStatus", function () {
                ...
                $.ajax({
                    ...
                    type: "post",
                    url: "<?php echo e(route('updateProductTypeStatus')); ?>",
...
<?php echo $__env->make('server.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/zariijsr/abrarmart.com/resources/views/server/product-type/index.blade.php ENDPATH**/ ?>