                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">Catalogues List</h5>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php if($banner->status == 'Active'): ?>
                                                                <a class="updateCatalogueStatus" id="product_type-<?php echo e($banner->id); ?>"
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <a class="dropdown-item" href="<?php echo e(route('catalogue.edit',$banner->id)); ?>"><i class="bx bx-edit-alt mr-1"></i> edit</a>
