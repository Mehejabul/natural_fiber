                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-content">
                                <form action="<?php echo e(Route('stock.update',$stock->id)); ?>" method="post"> <?php echo csrf_field(); ?>  <?php echo method_field('put'); ?>
                                    <div class="card-body">
                                            ...
                                            <div class="col-md-10">
                                                <fieldset>
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" aria-describedby="basic-Createon1" value="<?php echo e($stock->product->title); ?>" readonly>
                                                    </div>
                                                </fieldset>
                                                <fieldset class="mt-2">
                                                    <h5>Stock</h5>
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" aria-describedby="basic-Createon1" value="<?php echo e($stock->quantity); ?>" name="quantity" required>
                                                    </div>
                                                </fieldset>
                                                <fieldset class="mt-2">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" aria-describedby="basic-Createon1" value="<?php echo e($stock->available_qty); ?>" name="available_qty" required>
                                                    </div>
                                                </fieldset>
...
<?php $__env->startSection('js'); ?>
    ...
    <!-- END: Page JS-->
<?php $__env->stopSection(); ?>
<?php echo $__env->make('server.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/zariijsr/abrarmart.com/resources/views/server/stock/edit.blade.php ENDPATH**/ ?>