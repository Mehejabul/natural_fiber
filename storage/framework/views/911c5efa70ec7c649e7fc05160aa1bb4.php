        ...
        <div class="content-header-left col-12 mb-2 mt-1">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    ...
                    <?php endif; ?>
                    <h5 class="content-header-title float-left pr-1 mb-0">Product View Section Table</h5>
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb p-0 mb-0">
                            <li class="breadcrumb-item"><a href="<?php echo e(route('admin.dashboard')); ?>"><i class="bx bx-home-alt"></i></a>
                            </li>
                            <li class="breadcrumb-item active">Product View Sections
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">Product View Sections List</h5>
                            <div class="heading-elements">
                                <ul class="list-inline mb-0">
                                    <li class="ml-2"><a href="<?php echo e(route('view-section.create')); ?>" class="btn btn-primary">+ Create</a></li>
                                </ul>
                            </div>
                        </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php if($banner->status == 'Active'): ?>
                                                                <a class="updateViewSectionStatus" id="product_type-<?php echo e($banner->id); ?>"
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <a class="dropdown-item" href="<?php echo e(route('view-section.edit',$banner->id)); ?>"><i class="bx bx-edit-alt mr-1"></i> edit</a>
...
<?php $__env->startSection('js'); ?>
    ...
    <script>
        ...
        $(document).ready(function (){
            $(document).on("click", ".updateViewSectionStatus", function () {
                ...
                $.ajax({
                    ...
                    type: "post",
                    url: "<?php echo e(route('updateViewSectionStatus')); ?>",
...
<?php echo $__env->make('server.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\client_lifestyle\resources\views/server/view_section/index.blade.php ENDPATH**/ ?>