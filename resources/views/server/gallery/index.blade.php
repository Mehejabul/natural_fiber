                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        <a href={{route('gallery.create')}} class="btn btn-primary mb-2  align-items-center"> Create
                                            </a>
                                            ...
                                            <table class="table add-rows">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th>
                                                             <img src="{{ asset('images/gallery/'.$gallery->image) }}" id="output" alt="img" width="100px" height="auto" class="mt-2 mx-1">
                                                        </th>
                                                        <th></th>
                                                        <th></th>
                                                         <td>
