            ...
            <div class="col-12">
                ...
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb p-0 mb-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('view-section.index') }}">Product View Sections</a>
                        </li>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-content">
                        <form action="{{ route('view-section.update',$banner->id) }}" method="post" enctype="multipart/form-data"> @csrf @method('put')
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-10">
                                        {{-- <fieldset>
                                        ...
                                        <img src="{{ asset('images/product_type/'.$banner->image) }}" id="output" alt="logo" width="600px" height="200px" class="mt-2 mx-1">
                                        @endif --}}
                                        {{-- <img > --}}
                                        ...
                                        {{-- <fieldset class="mt-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea class="form-control" id="basicTextarea" rows="3" placeholder="" name="first_text">{{ $banner->first_text }}</textarea>
                                            </div>
                                        </fieldset>--}}
                                        <fieldset class="mt-2">
