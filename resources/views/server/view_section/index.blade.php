                        ...
                        <div class="card-header">
                            ...
                            <div class="heading-elements">
                                <ul class="list-inline mb-0">
                                    <li class="ml-2"><a href="{{ route('view-section.create') }}" class="btn btn-primary">+ Create</a></li>
                                </ul>
                            </div>
                        </div>
                                        ...
                                        <tbody>
                                            @if ($banners)
                                                @foreach ($banners as $banner)
                                                    <tr>
                                                        {{-- <td class="text-bold-600" ><img src="{{ asset('images/product_type/'.$banner->image) }}" alt="" height="150px"></td> --}}
                                                        {{-- <td>{{ $banner->first_text }}</td>--}}
                                                        <td>{{ $banner->title }}</td>
                                                        <td>
                                                            @if($banner->status == 'Active')
                                                                <a class="updateViewSectionStatus" id="product_type-{{ $banner->id }}"
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <a class="dropdown-item" href="{{ route('view-section.edit',$banner->id) }}"><i class="bx bx-edit-alt mr-1"></i> edit</a>
                                                                    {{-- <form action="{{ route('view-section.destroy',$banner->id) }}" method="post"> @csrf @method('Delete')
        ...
        $(document).ready(function (){
            $(document).on("click", ".updateViewSectionStatus", function () {
                ...
                $.ajax({
                    ...
                    type: "post",
                    url: "{{ route('updateViewSectionStatus') }}",
