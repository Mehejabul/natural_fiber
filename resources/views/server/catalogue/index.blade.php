                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if($banner->status == 'Active')
                                                                <a class="updateCatalogueStatus" id="product_type-{{ $banner->id }}"
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <a class="dropdown-item" href="{{ route('catalogue.edit',$banner->id) }}"><i class="bx bx-edit-alt mr-1"></i> edit</a>
                                                                    {{-- <form action="{{ route('catalogue.destroy',$banner->id) }}" method="post"> @csrf @method('Delete')
