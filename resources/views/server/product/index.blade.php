                                            ...
                                            @if ($products)
                                                @foreach ($products as $product)
                                                    <tr>
                                                        ...
                                                        <td class="text-bold-600 text-primary">{{ ucwords($product->title) }}</td>
                                                        <td>{{ $product->code }}</td>
                                                        <td>{{ $product->unit->title }}</td>
                                                        <td>@if ($product->category)
                                                            {{ $product->category->name }}
                                                        @endif</td>
                                                        <td>@if ($product->catalogue)
                                                        ...
                                                        <td class="text-danger">{{ $product->alert_stock }}</td>
                                                        <td>@if ($product->viewSection)
                                                            {{ $product->viewSection->title }}
                                                        @endif</td>
                                                        <td>@if ($product->image)
