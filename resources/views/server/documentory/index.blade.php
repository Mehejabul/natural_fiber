                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        <a href={{route('documentory.create')}} class="btn btn-primary mb-2  align-items-center"> Create
                                            </a>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table add-rows">
                                                ...
                                                <tbody>
                                                        ...
                                                        @foreach ($documentories as $documentory) 
                                                    <tr>
                                                        
                                                        <td>
                                                           <iframe
                                                            src="{{$documentory -> company_documentory}}"
                                                        ...
                                                        <td></td>
                                                         <td>
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                ...
                                                                <a href="{{ route('documentory.edit', $documentory->id) }}" class="dropdown-item">
                                                                        <i class="bx bx-edit-alt mr-1"></i> Edit
                                                                </a>

                                                             
                                                                    <form action="{{ route('documentory.destroy',$documentory->id) }}" method="post"> @csrf @method('Delete')
