                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                           <div >
                                            ...
                                            <textarea name="short_description" id="description">{{$about -> short_description}}</textarea>
                                            </fieldset>

                                            <fieldset class="mt-2">
                                            <h5>Description</h5>
                                            <textarea name="details_description" id="details_description">{{$about -> description}}</textarea>
                                            </fieldset>
                                            {{-- <h3>Title</h3>
                                            {!! $product->details_description !!}
                                                <input value="{{$gallery -> title}}" type="title" name="title" class="form-control" id="inputGroupFile04" aria-describedby="inputGroupFileAddon04" required> --}}
                                            {{-- <h3>Name</h3>
                                                <input value="{{$gallery -> name}}" type="name" name="name" class="form-control" id="inputGroupFile04" aria-describedby="inputGroupFileAddon04" required> --}}
