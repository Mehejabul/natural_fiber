                                            ...
                                            @if ($stocks)
                                                ...
                                                @endphp
                                                    <tr>
                                                      ...
                                                      <!--      @foreach ($stock->product->productvariation as $variation)-->
                                                      <!--          @php-->
                                                      <!--              $sum += $variation->quantity-->
                                                      <!--          @endphp-->
                                                      <!--      @endforeach-->
                                                      <!--          <span class="@if ($stock->product->alert_stock >= $sum)-->
                                                      <!--              text-danger-->
                                                      <!--          @endif">{{ $sum }}</span>-->
                                                      <!--      @else-->
                                                      <!--      0-->
                                                      <!--  @endif</td>-->
                                                      <td>
                                                                <span class="@if ($stock->product->alert_stock >= $stock->available_qty)
                                                                    text-danger
                                                                @endif">{{ $stock->available_qty }}</span>
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    {{-- @can('stock.show') --}}
                                                                        <a class="dropdown-item" href="{{ route('stock.show',$stock->id) }}"><i class="bx bxs-spreadsheet mr-1"></i> Details</a>
                                                                    {{-- @endcan --}}
                                                                    {{-- @can('stock.edit') --}}
                                                                        <a class="dropdown-item" href="{{ route('stock.edit',$stock->id) }}"><i class="bx bx-edit-alt mr-1"></i> edit</a>
                                                                    {{-- @endcan --}}
