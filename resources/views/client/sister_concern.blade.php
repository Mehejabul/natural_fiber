        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="sister_concern_image">
                    ...
                    <a href="{{ route('sister_concern_single') }}"><p>GOLDEN BEVERAGE</p></a>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="sister_concern_image">
                    <img src="{{asset('images/golden-jute/sister_concern/golden_jute_product.jpg')}}">
                    <a href="{{ route('sister_concern_single') }}"><p>GOLDEN JUTE Poduct</p></a>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="sister_concern_image">
                    <img src="{{asset('images/golden-jute/sister_concern/global_golden_craft.jpg')}}">
                    <a href="{{ route('sister_concern_single') }}"><p>GLOBAL GOLDEN JUTE & CRAFTS LTD.</p></a>
                </div>
            </div>
        </div>
    </div>
